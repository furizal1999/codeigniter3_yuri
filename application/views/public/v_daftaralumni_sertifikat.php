					    ...
					    <section id="specials" class="specials">
					      <div class="container">
					        <div class="section-title">
					          <h2>Daftar alumni yang belum mengambil sertifikat</h2>
					          <p><b class="text-danger">Perhatian :</b>Untuk alumni yang belum mengambil sertifikat, bisa langsung datang ke alamat Lembaga Yuri Computer. Terima Kasih!</p>
					        </div>
					        <div>
					          <table class="table">
					            <tr>

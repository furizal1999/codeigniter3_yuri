	      	...
	      	<div class="container-fluid">
					...
					<tbody>
						...
						<tr>
			                ...
			                <td class="text-center">
			                	<?php if(!empty($foto)){ ?>
			                	<form action="<?php echo base_url().'admin/siswa/lakukan_download';?>" method="post">
			                ...
			                <td style="width: 240px;" class="text-white">
			                    <a class="btn btn-xs btn-secondary" data-toggle="modal" data-target="#modal_edit<?php echo $id_siswa;?>"><i class="fa fa-pen"></i> Edit</a>
			                   	<a class="btn btn-xs btn-danger text-white" data-toggle="modal" data-target="#modal_hapus<?php echo $id_siswa;?>"></i> Non-aktifkan Akun</a>
			    ...
			    <!-- ============ MODAL ADD SISWA =============== -->
			        <div class="modal fade" id="modal_add_new" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			            ...
			            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/siswa/simpan_siswa'?>" enctype="multipart/form-data">
			                        ...
			                        <select name="id_program" class="form-control">
										...
										<?php
											foreach($combobox->result_array() as $i):
												$id_prog=$i['id_program'];
												$biaya=$i['biaya'];
										?>
										<option value="<?php echo $id_prog ?>"><?php echo $id_prog ?></option>
			    ...
			    <?php 
			        ...
			        <div class="modal fade" id="modal_edit<?php echo $id_siswa;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			            ...
			            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/siswa/edit_siswa'?>" enctype="multipart/form-data">
			                <div class="modal-body">
			    ...
			    <?php 
			     ...
			     <!-- ============ MODAL HAPUS SISWA =============== -->
			        <div class="modal fade" id="modal_hapus<?php echo $id_siswa;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
			            ...
			            <div class="modal-content">
			            <div class="modal-header">
			            	<h3 class="modal-title" id="myModalLabel">Non-aktifkan Siswa</h3>
			                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
			            </div>
			            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/siswa/hapus_siswa'?>">
			                <div class="modal-body">
			                    <p>Non-aktifkan akun <b><?php echo $nama_siswa;?></b></p>
			                </div>
			                <div class="modal-footer">
			            ...
			            <div class="modal-container">
			            	<table class="table">
			            		...
			            		<tr>
			            			...
			            			<td>:</td>
			            			<td>
			            				<?php $sudah_dibayar= $this->m_siswa->totaltagihan($id_siswa);
			            					if($sudah_dibayar==0){
			            						echo 'Rp. 0';
			            					}else{

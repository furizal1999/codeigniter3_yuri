...
class M_siswa extends CI_Model{
	...
	function simpan_siswa($nama_siswa,$tempat_lahir,$tgl_lahir,$jk,$no_hp,$alamat,$tgl_masuk,$id_program,$tagihan,$alumni,$tgl_selesai,$sertifikat, $fotobaru,$status_akun){
		$hasil=$this->db->query("INSERT INTO tb_siswa (nama_siswa,tempat_lahir,tgl_lahir,jk,no_hp,alamat,tgl_masuk,id_program,tagihan,alumni,tgl_selesai,sertifikat, foto, status_akun) VALUES ('$nama_siswa','$tempat_lahir','$tgl_lahir','$jk','$no_hp','$alamat','$tgl_masuk',$id_program,$tagihan,'$alumni','$tgl_selesai','$sertifikat','$fotobaru','$status_akun')");
		return $hasil;
	}

	function simpan_siswa_nophoto($nama_siswa,$tempat_lahir,$tgl_lahir,$jk,$no_hp,$alamat,$tgl_masuk,$id_program,$tagihan,$alumni,$tgl_selesai,$sertifikat,$status_akun){
		$hasil=$this->db->query("INSERT INTO tb_siswa (nama_siswa,tempat_lahir,tgl_lahir,jk,no_hp,alamat,tgl_masuk,id_program,tagihan,alumni,tgl_selesai,sertifikat,status_akun) VALUES ('$nama_siswa','$tempat_lahir','$tgl_lahir','$jk','$no_hp','$alamat','$tgl_masuk',$id_program,$tagihan,'$alumni','$tgl_selesai','$sertifikat','$status_akun')");
		return $hasil;
	}
	...
	function hapus_siswa($id_siswa){
		$hasil=$this->db->query("UPDATE tb_siswa SET status_akun='non_aktif' WHERE id_siswa='$id_siswa'");
		return $hasil;
	}
